 ...
 *
 * @package Beans\Fragments\Comments
 */
...
function beans_comment_author() {
	...
	echo beans_open_markup( 'beans_comment_title', 'div', array( 'class' => 'uk-comment-title vcard' ) );
...
function beans_comment_metadata() {
	...
	echo beans_open_markup( 'beans_comment_meta', 'div', array( 'class' => 'uk-comment-meta' ) );
		...
		echo beans_open_markup( 'beans_comment_time', 'time', array( 'datetime' => get_comment_time( 'c' ) ) );
